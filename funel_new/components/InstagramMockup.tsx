          ...
          <div className="instagram-post">
            ...
            <div className="post-header">
              ...
              <div className="post-user-info">
                ...
                <div className="post-location">Москва, Россия</div>
              </div>
            ...
            <div className="post-likes">
              <strong>12.5K</strong> лайков
            </div>

            {/* Post caption */}
            <div className="post-caption">
              <strong>anna_trox21</strong> Новый лук от VIBELOOK! 🔥 Они точно знают, что мне идет 💜
            </div>

            {/* Post comments */}
            <div className="post-comments">
              <div className="post-comment">
                <strong>masha_fashion</strong> Ого, какой стиль! 😍
              </div>
              <div className="post-comment">
                <strong>katya_looks</strong> Где брала? Хочу такую же!
              </div>
              <div className="post-comment">
                <strong>liza_style</strong> Тебе очень идет! ✨
              </div>
            </div>
